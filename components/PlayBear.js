...
class PlayComponent extends Component {
  ...
  getTimerValue = () => {
    ...
    let oldI = icebergsPosition[0][0]
    let oldJ = icebergsPosition[0][1]
    icebergsPosition.shift()
    icebergsPosition.push(newIcePosition(oldI, oldJ) )
  ...
  newIcePosition = (oldI, oldJ) => {
    ...
    if(directionColumn){
      ...
      if(oldI = squareDimensions){directionSecondaryDown = false}
      ...
      if(oldJ = squareDimensions){directionSecondaryRight = false}
